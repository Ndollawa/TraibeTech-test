...
export default function MenuUserProfile() {
  ...
  return (
    ...
    <div className="flex items-center space-x-4 gap-2">
        ...
        <img src={"/assets/images/user/defaultUser.jpeg"} className="w-7 rounded-full" alt="Profile"/>
        <h1>{"Ndollawa"}</h1>
    </div>
    <Link  to=""  onClick={()=>('')}  className="hover:bg-gray-800 hover:text-white p-2 rounded">
